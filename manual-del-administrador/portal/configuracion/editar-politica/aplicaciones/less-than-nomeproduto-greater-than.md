# Claro Monitor Empresarial

### Permisos Opcionales del Claro Monitor Empresarial&#x20;

Para el **Claro Monitor Empresarial**, se han creado dentro de las Configuraciones Administradas los Permisos Opcionales, para posibilitar activar el **Claro Monitor Empresarial** en dispositivos que no poseen los permisos solicitados en la activación.

Por lo tanto, para acceder a los “**Permisos Opcionales**", haga clic en los tres puntos "...", ubicados al final de la línea y haga clic en la opción "**Configuraciones Administradas**" de la aplicación **Claro Monitor Empresarial**.
