# Nueva Configuración Gestionada para hacer Opcional el Permiso de Programar Alarmas
...
Más información en la sección de [Claro Monitor Empresarial.](broken-reference)
